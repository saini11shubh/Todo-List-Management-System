...
const { updateTodoList, createTodoItem } = require("../models/validatorSchema");
//upload csv file
...
router.post('/todos', isAuthenticatedUser, validator(createTodoItem), catchErrors(todoController.addTodoItem));
